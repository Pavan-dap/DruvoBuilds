...
export const API_PROJECT_CREATE = `${API_BASE_URL}/projects/`;
export const API_PROJECT_UPDATE = (id) => `${API_BASE_URL}/projects/${id}/`;
export const API_PROJECT_DELETE = (id) => `${API_BASE_URL}/projects/${id}/`;
export const API_PROJECT_DETAILS = (id) => `${API_BASE_URL}/projects/${id}/`;
